...
class CompanyProfileSerializer(serializers.Serializer):
    ...
    bank_name      = serializers.CharField(max_length=255, required=False, allow_null=True, allow_blank=True)
    account_number = serializers.CharField(max_length=100, required=False, allow_null=True, allow_blank=True)
    ifsc_code      = serializers.CharField(max_length=20,  required=False, allow_null=True, allow_blank=True)
    logo_path      = serializers.CharField(               required=False, allow_null=True, allow_blank=True)
